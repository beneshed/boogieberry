        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal fade'>" +
                ...
                "</div></div></div>" +
              "</div>" +
              "<a class='btn btn-default" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1' data-toggle='modal'><i class='glyphicon glyphicon-picture'></i></a>" +
            "</li>";
        },
